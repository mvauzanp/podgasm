...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold mb-1"><i class="fas fa-ticket-alt text-primary me-2"></i>Buat Voucher Baru</h3>
            <p class="text-muted mb-0">Tambah kode voucher promo baru untuk program promosi perusahaan.</p>
        </div>
        <div>
            ...
            <div class="card border-0 shadow-sm rounded-4 p-4">
                <form action="{{ route('admin.vouchers.store') }}" method="POST" id="voucherForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" id="code" class="form-control form-control-lg text-uppercase" placeholder="Contoh: PROMOHEBAT" required value="{{ old('code') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="type" id="type" class="form-select form-select-lg" required>
                                ...
                                <option value="shipping_subsidy" {{ old('type') === 'shipping_subsidy' ? 'selected' : '' }}>Subsidi Ongkir (Rp)</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="hidden" name="value" id="value" value="{{ old('value') }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="hidden" name="min_purchase" id="min_purchase" value="{{ old('min_purchase', 0) }}" required>
                            </div>
                        ...
                        <div class="col-md-6 mb-3" id="max_discount_wrapper" style="display: none;">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="hidden" name="max_discount" id="max_discount" value="{{ old('max_discount') }}">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="quota" id="quota" class="form-control form-control-lg" placeholder="Contoh: 100" min="1" value="{{ old('quota') }}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="start_date" id="start_date" class="form-control form-control-lg" value="{{ old('start_date') }}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="end_date" id="end_date" class="form-control form-control-lg" value="{{ old('end_date') }}">
                    ...
                    <div class="mb-4">
                        <div class="form-check form-switch p-0 d-flex align-items-center gap-3">
                            <input class="form-check-input fs-3 m-0" type="checkbox" name="is_active" id="is_active" value="1" checked>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initialize display values if old values exist
