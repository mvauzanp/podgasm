        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.b2b-prices.update', $setting->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="min_qty" id="min_qty" class="form-control form-control-lg" value="{{ old('min_qty', $setting->min_qty) }}" min="1" placeholder="Contoh: 6" required>
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex gap-4">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="discount_type" id="type_nominal" value="nominal" {{ old('discount_type', $setting->discount_type) === 'nominal' ? 'checked' : '' }}>
                            <label class="form-check-label fw-medium" for="type_nominal">
                                Nominal Rupiah (Rp)
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="discount_type" id="type_percentage" value="percentage" {{ old('discount_type', $setting->discount_type) === 'percentage' ? 'checked' : '' }}>
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <input type="number" name="discount_value" id="discount_value" class="form-control form-control-lg" value="{{ old('discount_value', $setting->discount_value) }}" min="0" step="any" placeholder="Contoh: 5000" required>
                    </div>
