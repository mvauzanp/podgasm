                        ...
                        <div class="card bg-light border-0 rounded-4 shadow-sm h-100">
                            <div class="card-body p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="min_qty" id="min_qty" class="form-control form-control-lg" value="{{ old('min_qty', 1) }}" min="1" placeholder="Contoh: 1" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="text" id="discount_value_display" class="form-control form-control-lg" value="{{ old('discount_value') }}" placeholder="Contoh: 5.000" required>
                                        <input type="hidden" name="discount_value" id="discount_value" value="{{ old('discount_value') }}" required>
                                    </div>
                        ...
                        <div class="card bg-light border-0 rounded-4 shadow-sm h-100">
                            <div class="card-body p-4">
                                <div class="form-check form-switch mb-3 p-0 d-flex justify-content-between align-items-center">
                                    ...
                                    <input class="form-check-input fs-4 m-0" type="checkbox" name="enable_tier_2" id="enable_tier_2" value="1" {{ old('enable_tier_2') ? 'checked' : '' }} onchange="toggleTier2Section()">
                                </div>
                                ...
                                <div id="tier_2_fields" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="min_qty_2" id="min_qty_2" class="form-control form-control-lg" value="{{ old('min_qty_2', 6) }}" min="1" placeholder="Contoh: 6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="discount_type_2" id="type_nominal_2" value="nominal" {{ old('discount_type_2', 'nominal') === 'nominal' ? 'checked' : '' }}>
                                                <label class="form-check-label fw-medium" for="type_nominal_2">
                                                    Nominal Rupiah (Rp)
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="discount_type_2" id="type_percentage_2" value="percentage" {{ old('discount_type_2') === 'percentage' ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="text" id="discount_value_2_display" class="form-control form-control-lg" value="{{ old('discount_value_2') }}" placeholder="Contoh: 10.000">
                                            <input type="hidden" name="discount_value_2" id="discount_value_2" value="{{ old('discount_value_2') }}">
                                        </div>
