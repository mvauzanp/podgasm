                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="form-text text-muted mt-1 small" style="font-size: 0.78rem;">
                                    Disarankan diisi <strong>0</strong>. Untuk mencatat pengadaan pertama beserta harga beli & supplier, gunakan menu <strong>Barang Masuk</strong> setelah produk ini didaftarkan.
                                </div>

                            </div>

                            {{-- EXPIRED --}}
                            <div class="col-md-6 mb-4" id="expired_field_container">
                            ...
                            {{-- CUKAI --}}
                            <div class="col-md-6 mb-4" id="cukai_field_container">
                            ...
                            <div class="col-12 mb-4">
                                <div class="form-check form-switch p-3 bg-light rounded-4 border d-flex align-items-center justify-content-between">
                                    ...
                                    <input class="form-check-input fs-4 me-2" type="checkbox" id="has_variants" name="has_variants" value="1" onchange="toggleVariantSection()">
                                </div>
                            </div>

                            {{-- DOCK DAFTAR VARIAN --}}
                            <div class="col-12 mb-4" id="variant_section" style="display: none;">
                                            ...
                                            <table class="table align-middle mb-0" id="variant_table">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th>Stok Awal <span class="text-danger">*</span></th>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="upload-box position-relative p-4 rounded-4 border-2 border-dashed bg-light text-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small mb-0">
                                            Klik atau tarik satu atau beberapa gambar ke area ini
                                        </p>
...
function toggleVariantSection()
{
    ...
    if (hasVariants) {
        ...
        // Tambahkan baris pertama jika kosong
